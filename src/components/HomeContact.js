    ...
    <section id="contact-section" className="relative bg-black text-white py-24 sm:py-32 px-4 overflow-hidden">
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-12 max-w-5xl mx-auto">
          <a
            ...
            className="flex items-center gap-4 rounded-xl bg-zinc-900/70 px-6 py-5 sm:py-6 min-h-[88px] sm:min-h-[96px] hover:bg-zinc-800/80 transition-colors group min-w-0"
          >
          ...
          <div className="flex items-center gap-4 rounded-xl bg-zinc-900/70 px-6 py-5 sm:py-6 min-h-[88px] sm:min-h-[96px] min-w-0">
            ...
            <div className="min-w-0 flex-1 overflow-hidden">
              ...
              <p className="text-white font-medium text-sm break-words sm:whitespace-nowrap">Parklane Tower, 901 Business Bay</p>
            </div>
          </div>
      </div>

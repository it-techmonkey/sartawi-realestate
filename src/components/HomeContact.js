...
export default function HomeContact() {
  return (
    <section id="contact-section" className="relative bg-black text-white py-24 sm:py-32 px-4 overflow-hidden">
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-12 max-w-5xl mx-auto">
          <a
            href="tel:+97145525643"
            className="flex items-center gap-4 rounded-xl bg-zinc-900/70 px-6 py-6 sm:px-8 sm:py-7 hover:bg-zinc-800/80 transition-colors group min-h-[100px] w-full"
          >
            <span className="flex-shrink-0 w-11 h-11 rounded-lg bg-zinc-800 flex items-center justify-center text-[#e0b973] group-hover:bg-[#e0b973]/10 transition-colors">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-white font-medium text-sm truncate">+971 45 525 643</p>
            </div>
          </a>
          <a
          ...
          >
            ...
            <div className="min-w-0 flex-1 overflow-hidden">
              ...
              <p className="text-white font-medium text-sm truncate">admin@sartawiproperties.com</p>
            </div>
          </a>
          <div className="flex items-center gap-4 rounded-xl bg-zinc-900/70 px-6 py-6 sm:px-8 sm:py-7 min-h-[100px] w-full min-w-0">
            <span className="flex-shrink-0 w-11 h-11 rounded-lg bg-zinc-800 flex items-center justify-center text-[#e0b973]">
            ...
            <div className="min-w-0 flex-1 overflow-hidden">
              ...
              <p className="text-white font-medium text-sm truncate sm:whitespace-nowrap">Parklane Tower, 901 Business Bay</p>
            </div>
          </div>
      </div>

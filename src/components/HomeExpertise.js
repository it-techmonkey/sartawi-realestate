  ...
  return (
    <section className="py-24 sm:py-32 px-4 bg-zinc-950 overflow-hidden">
      ...
      <div className="relative">
        <div className="flex gap-6 overflow-x-auto pb-4 px-2 snap-x snap-mandatory scrollbar-hide md:overflow-visible md:flex-wrap md:justify-center">
          {ITEMS.map((item, i) => (
            <ScrollReveal key={item.title} delay={i * 0.06}>
              <div className="flex-shrink-0 w-[280px] sm:w-[300px] snap-center rounded-2xl bg-black border border-zinc-800 p-8 hover:border-[#e0b973]/40 transition-colors">
                <div className="w-12 h-12 rounded-xl bg-[#e0b973]/15 flex items-center justify-center text-[#e0b973] mb-5">
